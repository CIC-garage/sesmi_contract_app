sap.ui.define([
...
], function (Controller, History, UIComponent, MessageBox, Filter, FilterOperator) {
	"use strict";
	...
	return Controller.extend("com.cicre.po.controller.BaseController", {
		...
		// WBS [E.A]
		_contractDialog: null,
		onWBSSelectionValueHelpPress: function (oEvent) {
			//  this.cleanWBSDialog();
			...
			var oTable = sap.ui.xmlfragment(this.getView().getId(), "com.cicre.po.view.fragments.SelectMultiWBSDialogTable", this);
			if (!this._contractDialog) {
				this._contractDialog = sap.ui.xmlfragment(this.getView().getId(), "com.cicre.po.view.fragments.SelectMultiWBSDialoge", this);
				this._contractDialog.setTable(oTable);
				// this._contractDialog.setFilterBar(this.getView().byId("idContractFilterBar"));
				this.getView().addDependent(this._contractDialog);
